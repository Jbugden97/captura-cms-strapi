...
export interface ApiSiteMediaSiteMedia extends Struct.CollectionTypeSchema {
  collectionName: 'site_medias';
  info: {
    displayName: 'Site Media';
    pluralName: 'site-medias';
    singularName: 'site-media';
  };
  options: {
    draftAndPublish: true;
  };
